...
--prgbox "Updating pacman repos for chaotic-aur" "arch-chroot /mnt pacman -Syy && pacman -Syy && arch-chroot /mnt pacman firefox-extension-localcdn --noconfirm" "$HEIGHT" "$WIDTH"
clear
