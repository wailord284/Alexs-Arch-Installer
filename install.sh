...
--prgbox "Installing Aurmageddon packages" "arch-chroot /mnt pacman -S ttf-symbola surfn-icons-git pokemon-colorscripts-git arch-silence-grub-theme-git bibata-cursor-translucent usbimager matcha-gtk-theme nordic-theme nordic-darker-standard-buttons-theme pacman-cleanup-hook ttf-unifont lscolors-git zramswap preload skeuos-gtk pacman-updatedb-hook graphite-gtk-theme-nord-rimless-compact-git needrestart dracula-gtk-theme catppuccin-gtk-theme-mocha --noconfirm" "$HEIGHT" "$WIDTH"
clear
